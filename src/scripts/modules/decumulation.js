...
(function () {
  ...
  const SECTIONS = [
    ...
    {
      id: 'wep_gpo',
      label_en: 'WEP / GPO repeal (Social Security Fairness Act 2024)',
      label_jp: 'WEP / GPO 廃止(2024 年社会保障公平法)',
      description_en: 'Late-2024 repeal removed the 50% SS reduction that hit 厚生年金 recipients for decades.',
      description_jp: '2024 年末の廃止により、長年厚生年金受給者を悩ませた 50% SS 減額が撤廃。',
      auto_show: () => true,
