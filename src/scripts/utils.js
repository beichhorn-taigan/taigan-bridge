...
(function () {
  ...
  const JP_TERMS = [
    ...
    { kanji: '日本国籍選択届',       furigana: 'にほんこくせきせんたくとどけ', en: 'Japanese Nationality Choice form (filed at 市役所 by age 22)' },
    ...
    { kanji: '国籍選択', furigana: 'こくせきせんたく', en: 'nationality choice (Japan requires by age 22 for dual citizens)' },
    ...
    { kanji: '民法',     furigana: 'みんぽう', en: 'Civil Code (§887-§890 governs intestacy)' },
